...
import { CamadaLechonesService } from 'src/app/services/camadaLechones';
...
@Component({
  selector: 'app-editar-camada',
  templateUrl: './editar-camada.component.html',
  styleUrls: ['./editar-camada.component.css']
})
export class EditarCamadaComponent {
  ...
  constructor(
    ...
    private camdaLechonesService: CamadaLechonesService,
  ) {}
  ...
  guardarCambios() {
    ...
    this.camdaLechonesService.editar(this.usuario.id, this.usuario).subscribe(
      (response) => {
