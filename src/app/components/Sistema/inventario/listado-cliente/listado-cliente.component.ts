  ...
  confirmDelete() {
    this.clienteService.delete(this.ToDelete.id).subscribe(
      () => {
        ...
        this.toastr.success('Cliente eliminado con éxito', 'Correcto!!', this.toastrConfigTime);
        // Ocultar el modal de confirmación después de eliminar
        this.showConfirmationModal = false;
      },
      (error) => {
        console.error('Error al eliminar el pacha', error);
        this.toastr.error('Error al eliminar el cliente', 'Incorrecto!!', this.toastrConfigTime);
