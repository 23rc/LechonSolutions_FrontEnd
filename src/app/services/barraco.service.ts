...
getData(): Observable<any[]> {
   return this.http.get<any[]>('http://localhost:3000/barraco');
}


insert(contenedorLocal: any) {
  return this.http.post(`http://localhost:3000/barraco/barracoInsertar`, contenedorLocal);
}
delete(id: number) {
  return this.http.delete(`http://localhost:3000/barraco/barracoEliminar/${id}`);
}
